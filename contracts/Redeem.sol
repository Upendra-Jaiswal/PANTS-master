/**
 *Submitted for verification at mumbai.polygonscan.com on 2023-12-22
*/
...
contract HuskyJoeHat is ERC721, Ownable {
    ...
    function mintHusky(uint256 maxHusky) public payable onlyOwner {
...
contract Redeem {
    ...
    IERC20 public beamsock;
    HuskyJoeHat public sockNFT;

    //10% FROM BURN GOES TO MARKETING address
    uint256 public marketing=10;
    address public addmarketing;

    address public dead= 0x000000000000000000000000000000000000dEaD;

    constructor(IERC20 _beamsock,HuskyJoeHat _sockNFT ) {
        beamsock=_beamsock;
        sockNFT=_sockNFT;
    }

    function BuyBurn(uint256 _amount) public {

        uint256 adjustedAmount = _amount * (10**18);

        beamsock.transferFrom(msg.sender,address(this),adjustedAmount);
        beamsock.transfer(addmarketing,(marketing.div(100)).mul(adjustedAmount));
        // beamsock.transfer(dead,beamsock.balanceOf(address(this)));

        sockNFT.mintHusky(_amount);
